...
function AddTask() {
  ...
  useEffect(() => {
    if (Cookies.get("signedin")) {
      setUserDatas(JSON.parse(localStorage.getItem("userLogged") as string));
    }
  }, []);
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full h-full ">
      ...
      <form className="flex flex-col w-90 m-10 p-3 " onSubmit={handleSubmit}>
        ...
        <div className="flex justify-evenly items-center m-3">
          ...
          <p className="text-l font-bold text-gray-900">Date de fin</p>
          <input
            type="date"
            onChange={handleChange}
            name="dueDate"
