...
function AddProject() {
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full h-full ">
      ...
      <form className="flex flex-col w-250 m-10 p-3 " onSubmit={handleSubmit}>
        <div className="flex items-center m-3 content-between">
          ...
          <p className="text-l font-bold text-gray-900">Nom de ton projet : </p>
          <input
            type="text"
        ...
        <div className="flex items-center m-3 content-between">
          ...
          <p className="text-l font-bold text-gray-900">Description : </p>
          <input
            type="text"
            onChange={handleChange}
            name="description"
